...
export default function Sidebar() {
	return (
		<div className="mb-5 flex w-full justify-between gap-2 border-b-2 border-b-blue-400 px-3 py-2 sm:mx-3 sm:h-full sm:w-20 sm:flex-col sm:border-r-2 sm:border-r-slate-400">
			<Link>
